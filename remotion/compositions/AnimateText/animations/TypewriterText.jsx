// PROJECT/remotion/compositions/animations/TypewriterText.jsx
...
export const TypewriterText = ({
  ...
  // --- Position ---
  // Same resolution pattern as DanceText: "custom" uses the % value,
  // everything else uses flex alignment on the AbsoluteFill wrapper
  // (handled in AnimateText). Here we just position the letter-row itself.
  const left =
    xPosition === "custom"
      ? `${customX}%`
      : xPosition === "left"
...
const top =
  ...
  // remaining duration just holds the finished static text.
